...
ghdl -a --std=08 ../../src-gen/vhdl/avalon/CellBufferIfcPackage.vhd
ghdl -a --std=08 ../../src-gen/vhdl/avalon/SpiControllerIfcPackage.vhd
ghdl -a --std=08 ../../src-gen/vhdl/avalon/SpiControllerIfcAvalon.vhd
...
ghdl -a --std=08 ../../src/vhdl/SpiControllerWithAvalonBus.vhd
...
ghdl -a --std=08 -frelaxed ../../tb/hdl/tb_top_avalon_infineon_spi_flash.vhd

echo "elaborate"
ghdl -e --std=08 -frelaxed tb_top_avalon 

cd ..

echo "start simulation"
./work/tb_top_avalon --vcd=./trace.vcd --stop-time=10000000ns
